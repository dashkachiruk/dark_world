  ...
  <div class="modal-background">
    <b-card class="w-50 back-dark-violet">
      <b-form class="mx-2">
        ...
        <b-row>
          <b-col lg="10">
            <p class="font-32-bold clr-white">Редактирование мероприятия</p>
          </b-col>

          <b-col lg="2">
            <b-row align-h="end">
              <b-button class="mr-3 back-transparent">
                <p class="font-16-normal clr-blue pb-0 mb-0">В архив</p>
              </b-button>
            </b-row>
          </b-col>
        </b-row>
